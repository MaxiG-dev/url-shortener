...
import dev.maxig.api_gateway.events.requests.InfoRequestEvent;
...
public class InfoController {
    ...
    public Mono<ResponseEntity<Object>> infoStats() {
        ...
        return Mono.deferContextual(contextView -> {
            ...
            kafkaTemplate.send(infoRequestTopic, traceId, JsonUtils.toJson(new InfoRequestEvent("stats", null, traceId)));
    ...
    public Mono<ResponseEntity<Object>> infoUrl(@PathVariable String shortUrl) {
        ...
        return Mono.deferContextual(contextView -> {
            ...
            kafkaTemplate.send(infoRequestTopic, traceId, JsonUtils.toJson(new InfoRequestEvent(null, shortUrl, traceId)));
