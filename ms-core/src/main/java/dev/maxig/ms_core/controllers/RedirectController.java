...
import dev.maxig.ms_core.enums.RedirectOperationsEnum;
import dev.maxig.ms_core.events.requests.RedirectRequestEvent;
...
public class RedirectController {
    ...
    public Mono<ResponseEntity<Object>> redirect(@PathVariable String shortUrl) {
        ...
        return Mono.deferContextual(contextView -> {
            ...
            kafkaTemplate.send(redirectRequestTopic, traceId, JsonUtils.toJson(new RedirectRequestEvent(RedirectOperationsEnum.GET_REDIRECT , shortUrl, traceId)));
